...
import style2 from "./spacex2.module.css"
const Spacex = () => {
  return (
    <section id={style2.container}>
      ...
      <div className={style2.Launch}>
        <h4>RECENT LAUNCH</h4>
        <h2>INTELSAT IS-40E MISSION</h2>

        <a href="">
          <div className={style2.Rewatch}>
            <span>REWATCH</span>
          </div>
        </a>
      </div>

      <figure className={style2.fig2}>
        <div className={style2.Starship}>
          <h2 className={style2.h2}>STARSHIP UPDATE</h2>

          <a href="">
            <div className={style2.Learnmore}>
      ...
      <figure className={style2.fig3}>
        <div className={style2.Starship}>
          <h2 className={style2.h2}>
      ...
      <footer>
        <div className={style2.Footer}>
          <span className={style2.spa}>SPACEX © 2022</span>
